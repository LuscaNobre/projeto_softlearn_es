...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script>
            (function() {
                try {
                    // Usa a mesma chave de settings para consistência
    ...
    <body class="font-sans antialiased">
        ...
        {{-- Adicionado dark:bg-custom-dark para usar a cor customizada no modo escuro (ajuste conforme seu tailwind.config.js) --}}
        <div class="flex h-screen bg-gray-100 dark:bg-custom-dark"> 
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <header class="h-16 bg-white dark:bg-gray-800 shadow-sm flex items-center justify-between px-6">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="relative">
                            {{-- Ajustado as cores de texto do ícone e input --}}
                        ...
                        <button id="theme-toggle" type="button" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 p-1 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none">
                            ...
                            {{-- Ícone do Sol (Padrão, visível no Light) --}}
                            ...
                            {{-- Ícone da Lua (Oculto inicialmente, visível no Dark) --}}
